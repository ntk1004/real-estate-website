...
public class UserService implements IUserService {
    ...
    @Override
    @Transactional
    public void resign(UserDTO newUser) throws MyException {
        ...
        if (newUser.getPassword().equals(newUser.getRePassword())) {
            ...
            throw new MyException("Mật khẩu nhập lại không khớp!");
        }
      userConverter.convertToDto(userRepository.save(userEntity));
    }
}
