                ...
                <div class="col-xs-12 a-left">
                    <ul class="desc-intro">
                        <li class="home">
                            ...
                            <span class="mx-1" style="color:#000000"> / </span>
                        </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 search-btn">
                        <button class="search-btn-text pb-0" style="background-color: rgb(0, 0, 0);">
...
<%--        <div>--%>
<%--            <button style="display: block; width: 70px; height: 30px;margin:20px 0 0 1330px;background-color:#D9A24A ;border-radius:40px ; font-size: 10px;">Đăng sản phẩm</button>--%>
<%--        </div>--%>
        <!-- CONTENT  -->
                        ...
                        <div class="product1 vip">
                            ...
                            <div class="product1-conntent">
                                <div class="product1-conntent-header">
                                    <a href="">${item.name} : ${item.nameUnit}</a>
                                </div>
                                ...
                                <ul class="product1-conntent-list">
                                    ...
                                    <li class="product1-conntent-item">
                                        ...
                                        <span>Loại BĐS: ${item.type}</span>
                                    </li>
                                    <li class="product1-conntent-item">
                                        <i class="fa-solid fa-earth-asia"></i>
                                        <span>Diện tích: ${item.value} m2</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="product1-footer">
                                <span class="product1-footer-cost">${item.price} Tỷ</span>
