...
<div class="page-wrapper">
    <!-- INTRO  -->
        <div class="intro ">
            <div class="title-page">Hỗ Trợ</div>
            <div class="row">
                <div class="col-xs-12 a-left">
                    <ul class="desc-intro">
                        <li class="home">
                            <a href="./ViewHome.html"><span style="color:#000000">Trang chủ</span></a>
                            <span class="mx-1" style="color:#000000 ;padding-right: 5px;">/</span>
                        </li>
                        <li class="intro-item" style=""><span>Liên hệ</span></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="google-map margin-bottom-30">
                            <div class="maps_iframe">
                                <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11222.167507007673!2d105.78643927967764!3d20.979178755407663!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135accdd8a1ad71%3A0xa2f9b16036648187!2zSOG7jWMgdmnhu4duIEPDtG5nIG5naOG7hyBCxrB1IGNow61uaCB2aeG7hW4gdGjDtG5n!5e0!3m2!1svi!2s!4v1740560662361!5m2!1svi!2s" width="100%" height="650" style=" border: #D9A24A; border-style:solid ; border-color: #D9A24A;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <h2 class="title-lienhe"><strong>Công ty cổ phần bất động sản VinHomes</strong></h2>
                        <div class="desc-lienhe">
                            <p>Được thành lập vào ngày 20/08/2008 với niềm đam mê và khát vọng thành công trong lĩnh vực
                                bất động sản. Nhờ chiến lược rõ ràng và hướng đi đúng, Vinhomes đã nhanh chóng phát triển
                            ...
                            <ul class="margin-bottom-15 link" style="list-style-type: none;">
                                <li>
                                    ...
                                    <span class="title-li"> Hà Nội, Việt Nam</span>
                                </li>
                                <li>
...
<style>
    .intro {
        background-image: url(https://ircdn.vingroup.net/storage/Uploads/0_Tintuchoatdong/2024/T1/A1.jpeg) !important;
